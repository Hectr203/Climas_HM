            ...
            <div className="flex items-center space-x-4 mt-4 lg:mt-0">
              ...
              <div className="bg-muted rounded-lg px-4 py-2">
                <div className="flex items-center space-x-2">
                  ...
                  <div className={`w-2 h-2 rounded-full ${currentShift === 'morning' ? 'bg-green-500' : 'bg-red-500'
                    }`}></div>
                </div>
              </div>
              ...
              <div className="flex bg-muted rounded-lg p-1 overflow-x-auto no-scrollbar sticky top-20 z-40">
                {panelOptions?.map((option) => (
                  <button
                    ...
                    className={`flex items-center justify-center space-x-2 px-3 py-2 rounded-md transition-smooth whitespace-nowrap min-w-[96px] ${activePanel === option?.value
