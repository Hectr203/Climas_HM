...
const quotationService = {
  ...
  async crearConstructor(data) {
    try {
      const response = await httpService.post(
        "cotizaciones/constructor/crear",
        data
      );
      return response;
    } catch (error) {
  ...
  async getRevision({ id, idCotizacion }) {
    try {
      ...
      const response = await httpService.get(
        `cotizaciones/revision/obtener${query}`
      );
      return response.data;
    } catch (error) {
  ...
  async getConstructorByCotizacionId(id) {
    try {
      const response = await httpService.get(
        `cotizaciones/constructor/obtener?idCotizacion=${id}`
      );
      return response.data;
    } catch (error) {
  ...
  async updateMateriales(idCotizacion, materiales) {
    try {
      const response = await httpService.patch(
        `cotizacion/${idCotizacion}/materiales`,
        { materiales }
      );
      return response.data;
    } catch (error) {
  ...
  async createVersion(idCotizacion, versionData) {
    try {
      const response = await httpService.post(
        `cotizacion/${idCotizacion}/version`,
        versionData
      );
      return response.data;
    } catch (error) {
  ...
  async getQuotationVersions(idCotizacion) {
    try {
      const response = await httpService.get(
        `cotizacion/${idCotizacion}/versiones`
      );
      return response.data;
    } catch (error) {
  ...
  async getVersionById(idCotizacion, versionId) {
    try {
      const response = await httpService.get(
        `cotizacion/${idCotizacion}/version/${versionId}`
      );
      return response.data;
    } catch (error) {
  ...
  async restoreVersion(idCotizacion, versionId) {
    try {
      const response = await httpService.post(
        `cotizacion/${idCotizacion}/version/${versionId}/restaurar`
      );
      return response.data;
    } catch (error) {
  ...
  async updateEstadoAprobacion(
    ...
    try {
      const response = await httpService.patch(
        `cotizacion/${id}/estado-aprobacion`,
        {
          estadoAprobacion,
          comentarios,
          modificadoPor,
  ...
  async getCotizacionesByEstado(estado, limite = 50, pagina = 1) {
    try {
      const response = await httpService.get(
        `cotizacion/estado/${estado}?limite=${limite}&pagina=${pagina}`
      );
      return response.data;
    } catch (error) {
